...
// Chapter 6 Exercise 7-8

#include "std_lib_facilities.h"

/*
7. Write a grammar for bitwise logical expressions. A bitwise logical expression
is much like an arithmetic expression except that the operators
